...
ipcMain.handle('legacy-data:status', () => ({ presentCount: 0, protectedCount: 0, canDelete: false }));
ipcMain.handle('legacy-data:delete', () => ({ presentCount: 0, protectedCount: 0, canDelete: false, deletedCount: 0 }));
