...
function sanitizeSettingsPatch(patch = {}) {
  ...
  if (patch.transcription && typeof patch.transcription === 'object') {
    ...
    if (Object.hasOwn(value, 'realtimeProvider') && ['openai', 'azure', 'deepgram', 'azureSpeech'].includes(value.realtimeProvider)) transcription.realtimeProvider = value.realtimeProvider;
    ...
    if (Object.hasOwn(value, 'azureSpeechRegion')) transcription.azureSpeechRegion = String(value.azureSpeechRegion || '').slice(0, 200);
    if (Object.hasOwn(value, 'azureSpeechPhrases')) transcription.azureSpeechPhrases = String(value.azureSpeechPhrases || '').slice(0, 2000);
    ...
    if (Object.hasOwn(value, 'meetingDetection') && typeof value.meetingDetection === 'boolean') transcription.meetingDetection = value.meetingDetection;
